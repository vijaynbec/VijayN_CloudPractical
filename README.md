...
# 🚀 Cloud Portfolio       <img src="./Banner.png" alt="Cloud Portfolio Banner" width="170x170"/>
...
| **Databricks - Fivetran Ingestion** | Datalake - Medallion Data flow | [Link](./07.Databricks%Datapipeline%with%Five%Tran) |
